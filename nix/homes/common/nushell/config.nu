...
let config = {
    ...
    # Enable to share the history between multiple sessions, else you have to close the session to
    # persist history to file
    sync_history_on_enter: true
    menus: [
        # Configuration for default nushell menus. Note the lack of souce parameter
        {
        ...
        # Example of extra menus created using a nushell source. Use the source field to create a
        # list of records that populates the menu
        {
            name: commands_menu
            only_buffer_difference: false
            marker: "# "
    ...
    keybindings: [
        ...
        }
        {
            ...
            keycode: char_x
            mode: emacs
            event: { until: [ { send: menu name: history_menu } { send: menupagenext } ] }
        }
        {
