...
$env.config = {
    ...
    datetime_format: {
        normal: '%a %F %T%.f %Z'    # shows up in displays of variables or other datetime's outside of tables
        table: '%F %T%.f %z'        # generally shows up in tabular outputs such as ls. commenting this out will change it to the default human readable datetime format
    }
